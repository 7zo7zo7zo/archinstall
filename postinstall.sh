...
#sudo pacman --noconfirm --needed -S xcolor xorg-xfd xorg-bdftopcf zathura-pdf-poppler ttf-font-awesome intellij-idea-community-edition alsa-utils xf86-input-synaptics nvidia nvidia-dkms ttf-liberation pamixer lxappearance hplip openjdk11-src unrar
git clone https://github.com/7zo7zo7zo/dwm-testing.git temp/dwm
...
#git clone https://github.com/phillbush/xclickroot.git temp/xclickroot
mkdir ~/.config
mv temp/* ~/.config
...
#cd ~/.config/xclickroot ; sudo make clean install
